"""
YOLOv11 Detection + OSTrack Tracking Pipeline for ERCP
...
# ===================== CONFIG =====================
YOLO_WEIGHTS = os.environ.get("YOLO_WEIGHTS", str(REPO_ROOT / "weights" / "ercp_best.pt"))
...
VIDEO_DIR = os.environ.get("VIDEO_DIR", str(REPO_ROOT / "data" / "videos" / "ercp"))
OUTPUT_DIR = os.environ.get("OUTPUT_DIR", str(REPO_ROOT / "outputs" / "detect_track" / "ercp"))
...
CLASS_NAMES = ['papillary orifice', 'lumen', 'calculus']
# priority: calculus(2) > lumen(1) > papillary orifice(0). When multiple classes detected, keep the highest priority one.
