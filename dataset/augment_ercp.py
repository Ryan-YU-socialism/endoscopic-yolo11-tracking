...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Augment YOLO training images and labels for ercp dataset.")
    parser.add_argument(
        "--data-root",
        type=Path,
        default=Path(os.environ.get("DATA_ROOT", repo_root / "dataset" / "ercp_labelled_training_0606_resized_720_yolo")),
